...
- Rendering R2 foundation: branchless scene-lit toon/grass/water plus a bounded five-material Energy combat palette, player-owned damage/parry Shield pulses, and texture-free Ice/Snow and Lava domain materials use Bevy 0.19 shader contracts. Forge instantiates every shader family so editor smoke runs compile the complete gallery.
