            ...
            let ant = commands
                .spawn(PbrBundle {
                    mesh: Mesh3d(add_part(
                        meshes,
                        &style.modifiers,
                        Capsule3d::new(ant_l * 0.032, ant_l * 0.88),
                    )),
                    material: MeshMaterial3d(primary_mat.clone()),
